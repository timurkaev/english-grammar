### **Present Continuous (настоящее продолженное время)** используется для **описания действий, происходящих в момент речи, временных ситуаций, запланированных событий в будущем и изменяющихся тенденций.**
